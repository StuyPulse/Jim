...
public interface ArmTrajectories {
    ...
    public static ArmTrajectory generateTrajectory(ArmState src, ArmState dest) {
        ...
        // if ending within bumper, add first safety point
        else {
            if (srcState == ShoulderState.FRONT) {
                out.addState(kSafePointFront);
            } else {
    ...
    public interface Acquire {
        ArmState kTrajectory = new ArmState(
			new SmartNumber("Arm Trajectories/Acquire Front Shoulder", 80),
    ...
    public interface Ready {
        public interface Mid {
            ArmState kConeTipInBack = new ArmState(
                new SmartNumber("Arm Trajectories/Ready Mid Tip In Back Shoulder", 0),
                new SmartNumber("Arm Trajectories/Ready Mid Tip In Back Wrist", -60));
            ...
            ArmState kCubeBack = new ArmState(
                new SmartNumber("Arm Trajectories/Ready Mid Cube Back Shoulder", -30),
                new SmartNumber("Arm Trajectories/Ready Mid Cube Back Wrist", 45));
        }

        public interface High {
            ArmState kConeTipInBack = new ArmState(
                new SmartNumber("Arm Trajectories/Ready High Tip In Back Shoulder", 15),
                new SmartNumber("Arm Trajectories/Ready High Tip In Back Wrist", -15));
            ...
            ArmState kCubeBack = new ArmState(
                new SmartNumber("Arm Trajectories/Ready High Cube Back Shoulder", -180 - (-175)),
                new SmartNumber("Arm Trajectories/Ready High Cube Back Wrist", 180 - 130));
        }
    }
    ...
    public interface Score {
        public interface Mid {
            ArmState kConeTipInBack = new ArmState(
                new SmartNumber("Arm Trajectories/Score Mid Tip In Back Shoulder", -5),
                new SmartNumber("Arm Trajectories/Score Mid Tip In Back Wrist", -90));
        ...
        public interface High {
            ArmState kConeTipInBack = new ArmState(
                new SmartNumber("Arm Trajectories/Score High Tip In Back Shoulder", -7),
                new SmartNumber("Arm Trajectories/Score High Tip In Back Wrist", 20));
