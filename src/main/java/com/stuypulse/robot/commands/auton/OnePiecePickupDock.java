...
public class OnePiecePickupDock extends SequentialCommandGroup{
    ...
    private static final PathConstraints INTAKE_PIECE = new PathConstraints(3, 1.5);
    ...
    public OnePiecePickupDock() {
        ...
        addCommands(
            ...
            new ParallelCommandGroup(new WaitCommand(1.5).andThen(new SwerveDriveFollowTrajectory(
                                            paths.get("Intake Piece")).robotRelative()),
