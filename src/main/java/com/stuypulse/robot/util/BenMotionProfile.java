 ...
 */
public class BenMotionProfile implements IFilter {
     ...
     */
    public BenMotionProfile(Number velLimit, Number accelLimit, int steps) {
     ...
     */
    public BenMotionProfile(Number velLimit, Number accelLimit) {
        this(velLimit, accelLimit, kDefaultSteps);
    }

    public void reset(double currentArmPosition) {
        mOutput = currentArmPosition;
        mAccel = 0;
    }
